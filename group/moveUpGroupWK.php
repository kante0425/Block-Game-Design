...
$query1 = "update temp_wk_groups set workingBoardOrder = workingBoardOrder +1 where designId='". $designId ."' and workingBoardOrder >='". $index2 ."' and workingBoardOrder <'" . $index1 . "'";
